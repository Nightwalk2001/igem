...
<line>我们如何向高中和公众推广合成生物学。  <more>education</more></line>
    ...
    hp_interga: `
    <title>摘要：</title>
<line>人类实践是研究你的工作如何影响世界，以及世界如何影响你的工作。通过这项工作我们才能回答我们的项目对社会的影响问题，它是否真的会让世界变得更美好、是否符合伦理原则、是否可以安全实施。我们的人类实践工作始终尊重公众态度，利益相关者观点以及专家建议，整个项目的发展过程中都存在着这种对话。在Integrated Human Practices中，你可以看到我们为整合来自人类实践的反馈并将其纳入我们的项目中所做的努力。</line>
<title>对Design的影响</title>
...
<subtitle>想法——从相分离到CircRNA</subtitle>
